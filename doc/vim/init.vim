...
" 分屏
nnoremap <leader><leader>l :vsp<CR><C-w>l " 向右分屏
...
Plug 'tpope/vim-surround'  " 包裹
Plug 'neoclide/coc.nvim', {'branch': 'release'} " coc 智能补全插件

Plug 'iamcco/markdown-preview.vim' " markdown 预览 需要 python 支持
...
" format on enter, <cr> could be remapped by other vim plugin 按下 enter 补全第一个
